      ...
      <div style={{flex:1,display:'flex',overflow:'hidden'}}>
        ...
        {rooms.length>0&&(
          <div style={{width:220,background:'white',borderRight:`1px solid ${BORDER}`,overflowY:'auto',flexShrink:0}}>
            ...
            {rooms.map(room=>{const doc=room.doctor||room.appointment?.doctor;const isSel=selRoom?.id===room.id;return(
              (()=>{
                ...
                <div key={room.id}
                  ...
                  style={{padding:'11px 14px',borderBottom:`1px solid ${BORDER}`,
